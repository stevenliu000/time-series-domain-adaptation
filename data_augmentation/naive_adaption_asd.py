...
model_sub_folder = '/data_augmentation/naive_adaption/task_%s_waug_%f_slp_%f_tlp_%f_sclass_%f_scent_%f'%(args.task, args.waug, args.source_lbl_percentage, args.target_lbl_percentage, args.sclass, args.scent)
