...
parser.add_argument('--save_path', type=str, default="../train_related/change_lr_GAN", help='where to store data')
...
# optimizer
if args.isglobal:
    optimizerD_global = torch.optim.Adam(DNet_global.parameters(), lr=args.lr_gan / args.n_critic)
if args.islocal:
    optimizerD_local = torch.optim.Adam(DNet_local.parameters(), lr=args.lr_gan / args.n_critic)
