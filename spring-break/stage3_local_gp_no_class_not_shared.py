...
parser.add_argument('--n_critic', type=float, default=4, help='gap: Generator train GAP times, discriminator train once')
...
model_sub_folder = '/stage3_local_gp_no_class_not_shared/task_%s_gpweight_%f_dlocal_%f_critic_%f_sclass_%f'%(args.task, args.gpweight, args.dlocal, args.n_critic, args.sclass)
...
# pre-trained
model_PATH = '../train_related/spring_break/stage2_not_shared/task_3E_SClassWeight_0.700000_old'
