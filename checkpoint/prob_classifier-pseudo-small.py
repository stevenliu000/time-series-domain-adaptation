...
model_sub_folder = '/prob_classifier_pseudo_weight-small/task_%s_slp_%f_tlp_%f_sclass_%f_sbinary_loss_%f_spseudo_%f'%(args.task, args.source_lbl_percentage, args.target_lbl_percentage, args.sclass, args.sbinary_loss, args.spseudo)
