...
model_sub_folder = 'Linear_GAN/update_encoder_GAN_noG/lbl_percent_%f/task_%s_gpweight_%f_critic_%f_sclass_%f_globalonly'%(args.target_lbl_percentage , args.task, args.gpweight, args.n_critic, args.sclass)
