...
model_sub_folder = 'Linear_GAN/lbl_percent_%f/task_%s_gpweight_%f_critic_%f_sclass_%f_globalonly_%f'%(args.target_lbl_percentage , args.task, args.gpweight, args.n_critic, args.sclass, args.dglobal)
